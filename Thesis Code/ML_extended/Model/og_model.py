...
if __name__ == '__main__':
    ...
    ap_mean, ap_sample, eps_sim = simulate_ap_forecast(f107_forecast=f107_future, dates_forecast=dates_future, harmonics=HARMONICS,
                                                       regression_model=regression_model, ar_coeffs=ar_coeffs, sigma=sigma, eps_init=eps_init,
                                                       historical_f107=historical_f107, last_train_idx=len(df_hist)-last_n-1)
